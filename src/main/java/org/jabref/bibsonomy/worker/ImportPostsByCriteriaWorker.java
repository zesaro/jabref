...
import org.jabref.bibsonomy.util.JabRefModelConverter;
import org.jabref.bibsonomy.util.PluginCallBack;
...
public class ImportPostsByCriteriaWorker extends AbstractPluginWorker {
	...
	private BibSonomySearchType type;
	...
	public ImportPostsByCriteriaWorker(JabRefFrame jabRefFrame, String criteria, BibSonomySearchType type, GroupingEntity grouping, String groupingValue, boolean ignoreRequestSize) {
		super(jabRefFrame);
