...
package org.jabref.bibsonomy.listener;
...
import org.jabref.bibsonomy.action.AbstractPluginAction;
import org.jabref.bibsonomy.gui.GroupingComboBoxItem;
import org.jabref.gui.bibsonomy.BibSonomySearchType;
import org.jabref.bibsonomy.worker.ImportPostsByCriteriaWorker;
	...
	public void hyperlinkUpdate(HyperlinkEvent e) {
		...
		if(e.getEventType() == EventType.ACTIVATED) {
			...
			if(tokenizer.hasMoreElements()) {
				...
				ImportPostsByCriteriaWorker worker = new ImportPostsByCriteriaWorker(getJabRefFrame(), criteria, BibSonomySearchType.TAGS, ((GroupingComboBoxItem) visibilityComboBox.getSelectedItem()).getKey(), ((GroupingComboBoxItem) visibilityComboBox.getSelectedItem()).getValue(), false);
