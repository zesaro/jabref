...
package org.jabref.bibsonomy.gui;
...
import org.jabref.bibsonomy.action.RefreshTagListAction;
import org.jabref.bibsonomy.action.SearchAction;
import org.jabref.bibsonomy.action.ShowSettingsDialogAction;
import org.jabref.bibsonomy.action.UpdateVisibilityAction;
import org.jabref.bibsonomy.listener.PluginHyperLinkListener;
import org.jabref.bibsonomy.listener.VisibilityItemListener;
import org.jabref.gui.bibsonomy.BibSonomySearchType;
	...
	private JComboBox<?> getSearchTypeComboBox() {
		if (searchTypeComboBox == null) {
			...
			SearchTypeComboBoxItem[] items = new SearchTypeComboBoxItem[] {
					new SearchTypeComboBoxItem(BibSonomySearchType.FULL_TEXT, "Full text"),
					new SearchTypeComboBoxItem(BibSonomySearchType.TAGS, "Tag")
			};
